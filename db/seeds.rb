...
pet3 = Pet.new({ 'name' => 'Dodo',  'type' => 'parrot', 'date_of_birth' => 'August 2011', 'treatment_notes' => 'Take rest', 'vet_id' => vet1.id, 'customer_id' => customer3.id })
pet4 = Pet.new({ 'name' => 'Zeus',  'type' => 'dog', 'date_of_birth' => 'March 2016', 'treatment_notes' => 'Eat a lot of bones and skins', 'vet_id' => vet3.id, 'customer_id' => customer1.id })
